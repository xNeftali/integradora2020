<?php 
    ...
    $sel=$con->query("select * from clientes where id='$id'");
    ...
    if($_SERVER['REQUEST_METHOD']=="POST")
     {
        if(!empty($_POST['nombre'])&&!empty($_POST['apellido1'])&&!empty($_POST['apellido2'])&&!empty($_POST['telefono']))
        {
            ...
            $up=$con->query("update clientes set nombre='$nom', apellido1='$apep', apellido2='$apem', edad='$ed', calle='$cal', numero='$num', colonia='$col', telefono='$tel' where id = '$id' ");
            ...
            if($up)
            ...
            else
                {
                    ...
                    echo "<script> alert('Error Al Actualizar Cliente. Verifique, Por Favor') </script>";
