                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="table_data" colspan="2" >
                               <a class="btn_acciones" href="actualizar4.php?id= <?php echo $fila['id'] ?>"><img src="editar.png" alt=""></a>
                               <a class="btn_acciones" href="eliminar4.php?id= <?php echo $fila['id'] ?>"><img src="eliminar.png" alt=""></a>
                            </td>
                        </tr>      
